...
A third exact-source workflow attempt remained provider-limited. Run `33944653729`, attempt 3, produced artifact `9963861552` (`candidate7-pass2-qualification-33944653729-attempt-3`), archive SHA-256 `d4bf801a4fb31d846b026581fbc1f2c9709d62f75b74cd734733e183a92e97a9`. Its first D003 call returned transient `HTTP_429`, with zero accepted outputs and no D009 call. `evidence/candidate7-frozen-qualification-attempt-3-inconclusive.json` pins the preserved evidence.
