...
def main() -> int:
    ...
    if supervisor_head() != prereg.get("supervisor_source_revision") or os.getenv("GITHUB_SHA") != prereg.get("supervisor_source_revision"):
        raise ValueError("official supervisor checkout differs from preregistration")
